...
4. **Auto-detect** (optional): click "Auto square" or "Auto hex" to automatically detect grid points and fit the lattice. Works best on clear phase contrast images with regular spacing
