"""muapplication kill – train classifiers and analyze kill curves for micropattern experiments.
...
def dataset(
    ...
    try:
        from ..apps.kill.core import _load_annotations
...
def plot(
    ...
    from ..apps.kill.core import _find_violations, _load_csv
