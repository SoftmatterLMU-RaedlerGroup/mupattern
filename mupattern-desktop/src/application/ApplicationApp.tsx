...
export default function ApplicationApp() {
  ...
  const handleExpressionSelect = useCallback(
    (path: string, rows: Array<{ t: number; crop: string; intensity: number; area: number; background: number }>) => {
  ...
  return (
    <div className="flex flex-col h-screen">
      <AppHeader
        title="Application"
        subtitle="Expression and kill analysis"
        backTo="/workspace"
      />
        ...
        <div className="flex-1 flex items-center justify-center p-6">
          ...
          <div className="flex flex-1 min-h-0">
            <Tabs.Root defaultValue="expression" className="flex flex-1 min-h-0 flex-col">
              ...
              <div className="flex flex-1 min-h-0">
                <Tabs.Content value="expression" className="flex flex-1 min-h-0 mt-0 data-[state=inactive]:hidden">
                ...
                <Tabs.Content value="kill" className="flex-1 overflow-auto p-6 mt-0 data-[state=inactive]:hidden">
